...
public class WordMapper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String CREATE_WORDS_TABLE = "CREATE TABLE " + TABLE_WORDS + "("
				+ COLUMN_WORD + " TEXT PRIMARY KEY," + COLUMN_MEANING
				+ " TEXT," + COLUMN_IMAGE_URL + " TEXT," + COLUMN_AUDIO_URL
				+ " TEXT" + COLUMN_PARENT + " INTEGER " + ")";
...
//		+ " ON " + TABLE_WORDS+"."+ COLUMN_PARENT + "=" + TABLE_TOPICS + "." + "id" 
	}
